package com.ebookfrenzy.appindexing.provider;

import com.ebookfrenzy.appindexing.MyDBHandler;
...
public class MyContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY =
            "com.ebookfrenzy.appindexing.provider.MyContentProvider";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case PRODUCTS:
                rowsDeleted = sqlDB.delete(MyDBHandler.TABLE_LOCATIONS,
                        selection,
                        selectionArgs);
                break;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
            case PRODUCTS:
                id = sqlDB.insert(MyDBHandler.TABLE_LOCATIONS,
                        null, values);
                break;
            default:
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        queryBuilder.setTables(MyDBHandler.TABLE_LOCATIONS);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            case PRODUCTS:
                rowsUpdated =
                        sqlDB.update(MyDBHandler.TABLE_LOCATIONS,
                                values,
                                selection,
                                selectionArgs);
                break;
